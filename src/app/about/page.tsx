        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-start">
            <div className="space-y-6 text-[#374151] leading-relaxed">
              <p className="text-lg">
                My career has been a deliberate journey from building things to leading teams that build things —
                and eventually to shaping the strategy behind what gets built at all.
              </p>
              <p>
                I spent years in the trenches: writing code, designing interfaces, wrangling data.
                That hands-on foundation gives me something a lot of executives lack — I can actually
                talk to engineers, not just at them.
              </p>
              <p>
                ...
                of the largest Microsoft Teams deployments ever — 30,000+ employees across multiple countries.
              ...
              <p>
                My philosophy is what I call <strong className="text-[#1a1a2e]">&ldquo;just enough&rdquo; CIO thinking</strong> —
                listening to users and interpreting targeted data yields better outcomes than complex frameworks
                and bloated governance. Technology should serve people, not the other way around.
              </p>
              <p>
                I believe enterprise-grade thinking shouldn&apos;t be reserved for enterprises. Smaller
                organizations, nonprofits, and civic groups deserve the same strategic clarity — just
                delivered practically and without the overhead.
              </p>
